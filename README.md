...
ph-maker/0.2.2 darwin-x64 node-v8.10.0
$ maker --help [COMMAND]
USAGE
  $ maker COMMAND
...
...
_See code: [src/commands/goal.ts](https://github.com/arjunkomath/ph-maker-cli/blob/v0.2.2/src/commands/goal.ts)_
...
_See code: [src/commands/login.ts](https://github.com/arjunkomath/ph-maker-cli/blob/v0.2.2/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/arjunkomath/ph-maker-cli/blob/v0.2.2/src/commands/logout.ts)_
...
_See code: [src/commands/project.ts](https://github.com/arjunkomath/ph-maker-cli/blob/v0.2.2/src/commands/project.ts)_
<!-- commandsstop -->
